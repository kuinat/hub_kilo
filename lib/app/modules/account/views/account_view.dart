                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        Text("Fikish Swagger",
                          style: Get.textTheme.headline6.merge(TextStyle(color: Get.theme.primaryColor, fontSize: 22)),
                        ),
                        SizedBox(height: 5),
                        Text('elfikish@gmail.com', style: Get.textTheme.caption.merge(TextStyle(color: Get.theme.primaryColor, fontSize: 18))),
                      ],
                    ),
                  ),
                ),
