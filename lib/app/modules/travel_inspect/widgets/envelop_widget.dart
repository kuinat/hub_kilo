...
class EnvelopWidget extends StatelessWidget {
  String envelopDescription;
  double envelopWeight;
  double envelopPrice;
  bool editing= false;
  Function onPressed;
  Function onEditPressed;
  double envelopHeight;
  double envelopWidth;
  double envelopLength;
  var envelopLuggageId;
  var luggageModelId;
  var imageFiles;

  EnvelopWidget({Key key,this.envelopDescription, this.envelopWeight, this.onPressed, this.editing, this.envelopLuggageId, this.envelopWidth, this.envelopHeight, this.envelopPrice, this.imageFiles, this.envelopLength, this.onEditPressed, this.luggageModelId}) : super(key: key);
        ...
        Container(
            ...
            child:Column(
                children: [
                  ...
                  Text('Envelope',
                    style: TextStyle(fontSize: 12.0, color: labelColor),
                  ),
            ...
            child: Column(
              children: [
                Row(
                  ...
                  children: [
                    Text('Price / Envelope: ', style: TextStyle(color: labelColor)),
                    Text(envelopPrice.toString()+' EURO', style: TextStyle(color: Colors.black, fontSize: 12)),
                  ],
                ),
                Row(
                  mainAxisAlignment: MainAxisAlignment.start,
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Text(envelopDescription, style: TextStyle(color: Colors.black, fontSize: 12))
                                    ],
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Text(envelopWeight.toString(), style: TextStyle(color: Colors.black, fontSize: 12))
                                    ],
                                                          ...
                                                          children: [
                                                            ...
                                                            ClipRRect(
                                                              ...
                                                              child: FadeInImage(
                                                                width: Get.width,
                                                                height: Get.height/2,
                                                                image: NetworkImage('${Domain.serverPort}/image/m2st_hk_airshipping.luggage/$envelopLuggageId/luggage_image${index+1}?unique=true&file_response=true',
                                                                    headers: Domain.getTokenHeaders()),
                                                                placeholder: AssetImage(
                                                                    "assets/img/loading.gif"),
                                                                imageErrorBuilder:
