...
class AddReceptionOfferForm extends GetView<TravelInspectController> {
    ...
    return Scaffold(
      //Get.theme.colorScheme.secondary,
        ...
        appBar: AppBar(
          ...
          elevation: 0,
          title: Obx(() => Text(
            !controller.editing.value ? 'Nouvelle offre de réception' : controller.shipping['display_name'].toString(),
                    ...
                    BlockButtonWidget(
                      onPressed: () async =>{
                        ...
                        if(controller.user.value.birthday == '--/--/--' || controller.user.value.birthplace =='--' || controller.user.value.street =='--' || controller.user.value.sex.toString() =='false'){
                          ...
                          for(var a=1; a<13; a++){
                            await controller.sendRoadImages(a, controller.imageFiles[a-1]),
                          },
                         await controller.createReceptionOffer(),
                    ...
                    BlockButtonWidget(
                      onPressed: () async =>{
                        controller.buttonPressed.value = true,
                          ...
                          controller.editReceptionOffer(controller.shipping)
      ...
      child: Column(
        children: [
          ...
          Expanded(
            ...
            controller.formStep.value == 0 ? FadeIn(delay: 30,child: build_book_road_travel(Get.context, ))
                ...
                if(controller.formStep.value == 1){
                  ...
                  if(controller.formStep.value == 2){
                    ...
                    if(!controller.createUser.value){
                      ...
                      if(controller.shipperDto.isNotEmpty){
                        controller.formStep.value++;
                        controller.showButton.value = true;
                      }else{
                        Get.showSnackbar(Ui.warningSnackBar(message: AppLocalizations.of(Get.context).selectBeneficiaryError));
            ...
            if(controller.formStep.value != 3){
              if(controller.formStep.value == 0){
                ...
                if(controller.formStep.value == 1){
                  ...
                  if(controller.formStep.value == 2){
                    if(!controller.createUser.value){
                      if(controller.editShipper.value){
                        if(controller.selectedUser.value){
  ...
  Widget build_book_road_travel(BuildContext context) {
                                                  ...
                                                  GestureDetector(
                                                      onTap: () {
                                                        ...
                                                        if(controller.luggageSelected.isNotEmpty){
                                                          ...
                                                          print(controller.luggageModels[i]['max_weight'].toString());
    ...
    return ListView(
        ...
        children: [Column(
          ...
          children: <Widget>[
            if(controller.editing.value)...[
              SwitchListTile( //switch at right side of label
                  value: controller.editShipper.value,
                  onChanged: (bool value){
                    controller.editShipper.value = value;
                    controller.createUserReceptionOffer.value = value;
                  },
                  title: Text('Edit Shipper', style: Get.textTheme.headline1.merge(TextStyle(fontSize: 14, color: Colors.black)))),

              if(!controller.editShipper.value)...[
    //controller.parcel_reception_shipper_partner_id.value = controller.shipping['receiver_partner_id'][0],
    // if(controller.shipping['receiver_partner_id'][0] == controller.users[index]['id'])...[
    // controller.shipperDto.value = controller.users[index];
    // ],
                ...
                Container(
                    height: 60,
                    decoration: BoxDecoration(
                        border:  Border.all(color: interfaceColor,width: 2) ,
                        borderRadius: BorderRadius.all(Radius.circular(10))
                    ),
                    padding: EdgeInsets.all(10),
                    child: Row(
                        ...
                        children: [
                          ClipOval(
                              child: FadeInImage(
                                  ...
                                  height: 40,
                                  fit: BoxFit.cover,
                                  image: NetworkImage('${Domain.serverPort}/image/res.users/${controller.shipping['parcel_reception_shipper'][0]}/image_1920?unique=true&file_response=true', headers: Domain.getTokenHeaders()),
                                  placeholder: AssetImage(
                                      "assets/img/loading.gif"),
                                  imageErrorBuilder:
                                      (context, error, stackTrace) {
                          ...
                          SizedBox(
                              ...
                              child: Row(
                                  ...
                                  children: [
                                    Expanded(
                                        child: Text(controller.shipping['parcel_reception_shipper'][1], style: Get.textTheme.headline4.merge(TextStyle(fontSize: 13, color: buttonColor)), overflow: TextOverflow.ellipsis,)
                                    )
                                  ]
                              )
                          )
                                                      ...
                                                      child: Obx(() => Column(
                                                          children: [
                                                            for(var a=0; a<controller.viewUsers.length; a++)...[
                                                              InkWell(
                                                                  onTap: ()=>{
                                                                    controller.shipperDto.value = controller.viewUsers[a],
                                                                    controller.parcel_reception_shipper_partner_id.value = controller.viewUsers[a]['partner_id'][0]['id'],
                                                                    controller.selectedIndex.value = a,
                                                                    controller.selectedUser.value = true,
                                                                    controller.createUser.value = false,
                                                                    controller.createUserReceptionOffer.value = false
                                                                  },
                                                                  child: UserWidget(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return GestureDetector(
                                  onTap: (){
                                    ...
                                    controller.shipperDto.value = controller.users[index];
                                    controller.parcel_reception_shipper_partner_id.value = controller.users[index]['id'];
                                    print(controller.parcel_reception_shipper_partner_id.value.toString());
        ...
        children: [Column(
          ...
          children: [
            ...
            Padding(
                ...
                child: Text('Shipper Details'.tr, style: Get.textTheme.headline4.merge(TextStyle(color: buttonColor)))
            ),
            SizedBox(height: 10),
            if(controller.editing.value)...[
              if(!controller.createUser.value)...[
                ...
                UserWidget(
                  user: controller.shipperDto['name'],
                  selected: false,
                  imageUrl: '${Domain.serverPort}/image/res.partner/${controller.shipperDto['id']}/image_1920?unique=true&file_response=true',
                ) :
                UserWidget(
                  user: controller.shipperDto['partner_id'][0]['name'],
                  selected: false,
                  imageUrl: '${Domain.serverPort}/image/res.partner/${controller.shipperDto['partner_id'][0]['id']}/image_1920?unique=true&file_response=true',
                )
              ]else...[
                if(!controller.selectedUser.value)
                  if(!controller.editShipper.value)...[
                    UserWidget(
                      user: controller.shipping['parcel_reception_shipper'][1],
                      selected: false,
                      imageUrl: '${Domain.serverPort}/image/res.users/${controller.shipping['parcel_reception_shipper'][0]}/image_1920?unique=true&file_response=true',
                    )
                  ],
              ...
              Obx(() => UserWidget(
                user: controller.selectedUser.value ? controller.shipperDto.isEmpty?'': controller.shipperDto['partner_id'][0]['name'] : controller.shipperDto['name'],
                selected: false,
                imageUrl: controller.selectedUser.value ?
                '${Domain.serverPort}/image/res.partner/${controller.shipperDto['partner_id'][0]['id']}/image_1920?unique=true&file_response=true'
                    :'${Domain.serverPort}/image/res.partner/${controller.shipperDto['id']}/image_1920?unique=true&file_response=true',
              ))
            ],
            Padding(
                padding: EdgeInsets.all(10),
            ...
            if((controller.travelCard['booking_type'] != null && controller.travelCard['booking_type'].toLowerCase() == "road") || Get.find<BookingsController>().offerExpedition.value || Get.find<BookingsController>().offerReception.value)...[
              Container(
                  padding: EdgeInsets.all(10),
                  margin: EdgeInsets.only(right: 10),
                  height: 170,
