...
class ReceptionOffersView extends GetView<TravelInspectController> {
    ...
    return Scaffold(
      //Get.theme.colorScheme.secondary,
        ...
        appBar: AppBar(
          ...
          elevation: 0,
          title: Obx(() => Text(
            !controller.editing.value ? 'Nouvelle Offre de Reception' : 'Modifier offre de reception',
                ...
                child: Center(
                    ...
                    BlockButtonWidget(
                      onPressed: ()async =>{
                        if(controller.depTown.text.isNotEmpty && controller.arrTown.text.isNotEmpty){
                          Get.toNamed(Routes.ADD_RECEPTION_OFFER_FORM),
                    ...
                    BlockButtonWidget(
                      onPressed: () async =>{
                        ...
                        Get.toNamed(Routes.ADD_RECEPTION_OFFER_FORM, arguments: {'shippingDto': Get.find<BookingsController>().shippingDetails, 'heroTag': 'services_carousel'}),
                      ...
                      text: !controller.buttonPressed.value ? SizedBox(
                        //width: Get.width/1.5,
                          child: Text(
                            AppLocalizations.of(context).continu.tr,
                            style: Get.textTheme.headline5.merge(TextStyle(color: Get.theme.primaryColor)),
                          )
                      ) : SizedBox(height: 20,
                          child: SpinKitThreeBounce(color: Colors.white, size: 20)),
                    ...
                    child: Column(
                      ...
                      children: [
                        Align(
                            ...
                            child: Text(controller.editing.value?"Modiffier les details d' offre de reception".tr:"Completer les details d' offre de reception".tr, style: Get.textTheme.headline2.merge(TextStyle(color: appColor, fontSize: 15))).paddingSymmetric(horizontal: 22, vertical: 5)).marginOnly(bottom: 20, top: 20),
