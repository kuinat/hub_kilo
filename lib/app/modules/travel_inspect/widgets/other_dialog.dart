...
class OtherDialog extends GetView<TravelInspectController> {
  var editing = false;
  var luggage;
  OtherDialog({Key key,this.editing, this.luggage}) ;
  @override
      ...
      child: ListView(
        ...
        children: [
          ...
          TextFieldWidget(
            isLast: false,
            readOnly: false,
            initialValue: controller.modelLuggageWeight.value.toString(),
            onChanged: (input) => controller.modelLuggageWeight.value = double.parse(input),
            hintText: "0.05 kg".tr,
            labelText: 'Number of ${controller.modelName.value.toLowerCase()} you want to ship'.tr,
          ...
          TextFieldWidget(
            isLast: false,
            readOnly: false,
            initialValue: controller.modelLuggageWidth.value.toString(),
            onChanged: (input) => controller.modelLuggageWidth.value = double.parse(input),
            hintText: "10 cm".tr,
          ...
          TextFieldWidget(
            isLast: false,
            readOnly: false,
            initialValue: controller.modelLuggageHeight.value.toString(),
            onChanged: (input) => controller.modelLuggageHeight.value = double.parse(input),
            hintText: "10 cm".tr,
          ...
          TextFieldWidget(
            isLast: false,
            readOnly: false,
            initialValue: controller.modelLuggageLength.value.toString(),
            onChanged: (input) => controller.modelLuggageLength.value = double.parse(input),
            hintText: "10 cm".tr,
          ...
          Container(
            ...
            child: Obx(() => ListTile(
              ...
              subtitle: Text((controller.modelLuggageHeight.value * controller.modelLuggageWidth.value * controller.modelLuggageLength.value).toString(),style: Get.textTheme.bodyText1.merge(TextStyle(color: Colors.black)),
              ),
            )),
          ),
              ...
              children: <Widget>[
                Card(
                    child: Padding(
                        ...
                        child: TextFormField(
                          initialValue: controller.modelLuggageDescription.value,
                          style: TextStyle(color: Colors.black),
                          cursorColor: Colors.black,
                          maxLines: 5,
                          textInputAction:TextInputAction.done ,
                          minLines: 2,
                          onChanged: (input) => controller.modelLuggageDescription.value = input,
          ...
          !editing?BlockButtonWidget(
            onPressed: ()=>{
                if (controller.modelLuggageWeight.value != 0.0 && controller.modelLuggageWidth.value != 0.0 &&
                    controller.modelLuggageHeight.value != 0.0 && controller.modelLuggageDescription.value.isNotEmpty) {
                  //if(controller.modelLuggageWeight.value <= luggage['quantity']){
                    if(controller.imageFiles.length==12){
                      controller.otherModel = OtherModel(
                        luggageType: controller.modelName,
                        otherDescription: controller.modelLuggageDescription.value,
                        otherHeight: controller.modelLuggageHeight.value,
                        otherWeight: controller.modelLuggageWeight.value,
                        otherQuantity: controller.modelLuggageQuantity.value,
                        otherWidth: controller.modelLuggageWidth.value,
                        otherLength: controller.modelLuggageLength.value,
                        imageFiles: controller.imageFiles.value,
                        luggageId: luggage['id'],
                        otherPrice: controller.modelLuggagePrice,
                          luggageModelId: luggage['luggage_type_id'][0]
                      ),
                      controller.selectedPackages.add(controller.otherModel),
                      //controller.kilosChecked.value = !controller.kilosChecked.value,
            ...
            onPressed: ()=>{
                if (controller.modelLuggageWeight.value != 0.0 && controller.modelLuggageWidth.value != 0.0 &&
                  ...
                  if(controller.imageFiles.length==12){
                    ...
                    controller.airShippingLuggageToEdit.add(controller.otherModel),
                    //controller.kilosChecked.value = !controller.kilosChecked.value,
                    controller.showAvailableLuggage.value = false,
                    Navigator.of(context).pop(),
